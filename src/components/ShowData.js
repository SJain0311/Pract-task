  ...
  return (
    <div>
      ...
      <div className="search-box">
            <input id="search-box" onChange={(e)=>setQuery(e.target.value)} className="search" placeholder="...Search" />
            ...
            <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle">
              ...
              <TableBody>
                ...
                {stableSort(users, getComparator(order, orderBy))
                 .filter((row)=>row.id.toString().toLowerCase().indexOf(query.toLowerCase()) !== -1)
